...
## Decisions
- **Decision:** Use 0.1×8 mm nickel strip for individual cell connections, and a 0.15×12 mm pure-nickel strip for each 4s pack lead.
...
- **Decision (design intent):** Include a layer of silicone thermal sheet between battery and shell.
  **Why:** Thermal management, and ensure batteries are seated properly in the casing grooves.

## Roadblocks
- Unable to find any off-the-shelf PCM materials that are easy to work with.

## Next steps
- [x] Replicate design of original battery spacer in CAD
